...
if __name__ == "__main__":
    df2 = pd.read_csv("../Federated_Learning_Forecasts/transformer_overloads.csv", sep=';', decimal='.')

    df3 = pd.read_csv("../Federated_Learning_Forecasts/transformer_overloads.csv", sep=';', decimal='.', dtype=str)
    ...
    plt.savefig('../Federated_Learning_Forecasts/Transformer_load.png', dpi=500, bbox_inches='tight')
